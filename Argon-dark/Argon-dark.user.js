// ==UserScript==
// @name         Oh-my-blackboard Argon-dark Theme
// @namespace    bb.cuhk.edu.cn
// @version      1.0
// @description  Argon-dark Theme for Blackboard
...
GM_addStyle(`
  ...
  .nav-link:hover,
  .global-nav-bar-wrap .global-nav-bar.logout a:hover,
  .bgBanner a:hover {
    background-color: rgba(0, 0, 0, 0.1) !important;
  }

  .nav-link span,
  .global-nav-bar-wrap .global-nav-bar.logout a span,
  .bgBanner a span {
    border: none !important;
    padding: 0 !important;
  }
  ...
  .card .collapsible,
  #content .portlet .collapsible {
    border: none;
    padding: 0;
  }

  .card .collapsible a,
  #content .portlet .collapsible a {
    text-decoration: none !important;
  }

  .card .collapsible a span,
  #content .portlet .collapsible a span {
    color: inherit !important;
    font-size: 1rem;
  }

  .vertical-nav-link,
  .locationPane .navigationPane .navPaletteTitle,
  ...
  .locationPane .navigationPane .navPaletteTitle span,
  .locationPane .navigationPane .courseMenu a span {
    color: rgba(0, 0, 0, 0.87) !important;
  }

  .vertical-nav-link:hover,
  .locationPane .navigationPane .navPaletteTitle:hover,
  .locationPane .navigationPane .courseMenu a:hover {
    background-color: rgba(0, 0, 0, 0.05);
    text-decoration: none !important;
  }

  .vertical-nav-link:hover span,
  .locationPane .navigationPane .navPaletteTitle:hover span,
  .locationPane .navigationPane .courseMenu a:hover span {
    color: rgba(0, 0, 0, 0.87) !important;
  }
  ...
  .bgBanner {
    background: linear-gradient(87deg, #111111, #222222 100%) !important;
  ...
  .locationPane #contentPanel .contentList li .details .enerated ul {
    padding: 0 0 0 1rem;
    margin: 0;
  }
  ...
  .locationPane .filterBarHorizontal #filterby li a:before,
  .locationPane .filterBarHorizontal #filterby li a:after,
  ...
  .locationPane .container .cell div,
  .locationPane .container .cell span {
    margin-top: 5px;
  }
  ...
  .locationPane .container .cell.grade span,
  .locationPane .container .cell.grade div {
    font-size: .9rem;
    margin-top: 3px;
  }
  ...
  .blockGroups li span.itemHeadOpen+p,
  .blockGroups li span.itemHeadOpen+p {
  ...
  .blockGroups:hover .itemHeadOpen:hover {
    background: #222 !important;
  }

  .blockGroups:active .itemHeadOpen:active {
    background: #333 !important;
  }
  ...
  .stream_item .stream_context .inlineContextMenu a.browse {
    color: #39C5BB !important;
  }
  ...
  .gradeHeader .grade.readOnly .gradeEntry {
    background: #0000 !important
  }
  ...
  .attemptHeader {
    ...
    -webkit-box-shadow: 0 1px 1px #232324;
    box-shadow: 0 1px 1px #19191a;
  ...
  .vertical_filter .stream_full {
    background: #222
  }

  .vertical_filter .stream_dynamic_filters ul {
    background: #333;
  }

  .vertical_filter .stream_dynamic_filters h5 {
    background: #444;
  }
  ...
  .stream_item.stream_new_entry:hover {
    background: #111 !important;
  }

  .active_stream_item:hover {
    background: #111 !important;
  }

  #left_stream_alerts .stream_item:hover {
    background: #222 !important;
  }
  ...
  .gradeTableNew .calculatedRow.row {
    ...
    box-shadow: 0px 0px 21px 4px #000 inset;
    background: #111;
  }
  ...
  .mybb.gradeTableNew .grades_header {
    background: #222
  }
  ...
  .vertical_filter .stream_dynamic_filters li a {
    color: #20aac2;
  }
